...
class AdvertisementController extends Controller
{
    ...
    public function searchAds(Request $request)
    {
        ...
        $advertisements = Advertisement::search($query)->get();

        return view('product.search',compact('advertisements'));

        //$search_text = $_GET['query'];
        //$advertisements = Advertisement::where('description', 'LIKE', "%$search_text%")
                                         //->orWhere('name', 'LIKE', "%$search_text%")
                                         //->orWhere('listing_location', 'LIKE', "%$search_text%")
                                         //->orWhere('product_condition', 'LIKE', "%$search_text%")
                                         //->orWhere('price_status', 'LIKE', "%$search_text%")
                                         //->get();
