...
@section('content')
    ...
    <tr>
            ...
            <div id="carouselExampleControls{{$ad->id}}" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{ Storage::url($ad->feature_image) }}" width="70">
                    </div>
                    <div class="carousel-item">
                    <img src="{{ Storage::url($ad->first_image) }}" width="70">
                    </div>
                    <div class="carousel-item">
                    <img src="{{ Storage::url($ad->second_image) }}" width="70">
                    </div>
                    </div>
        ...
        <td>{{$ad->name}}</td>
        <td style="color:blue">NGN {{$ad->price}}</td>
        <td>
        @if($ad->published==1)
        ...
        <td> <a target="_blank" href="{{route('product.view',[$ad->id,$ad->slug])}}"><button class = "btn btn-info">View</button></a></td>
        <td>
