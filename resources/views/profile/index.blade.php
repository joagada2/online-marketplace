    ...
    <div class="container">
        <div class="row">
            ...
            <form action="{{route('update.profile')}}" method="post" enctype="multipart/form-data">@csrf
                <div class="card">
                    <div class="card-header text-white" style="background-color: #001f3f">Update profile</div>
            ...
            <div class="col-md-4">
                ...
                <form action="{{ route('user-password.update') }}" method="post">@csrf
                    @method('PUT')
                    <div class="card">
                        <div class="card-header text-white" style="background-color: #001f3f">Change password</div>
                        <div class="card-body">
                            <div class="form-group">
